...
const Faq = () => {
  return (
    <main className="bg-white text-gray-800 m-10 border border-gray-300 rounded-t-xl h-230">
      {/* Header Section */}
      <section className="bg-[#2e3a5e] text-white py-10 px-6 rounded-t-xl text-center relative  flex items-center justify-center">
       ...
       <div> <h1 className="text-2xl md:text-3xl font-bold">Frequently Asked Questions</h1></div>
      </section>

        <img src="/public/images/FAQ-question1.png" className="relative left-80 top-40 opacity-10  w-50 z-1 " />
      {/* FAQ Content */}
      <section className="max-w-6xl mx-auto px-0 py-12  items-start">
        {/* Questions */}
        <div className="relative -top-40 space-y-6 z-2">
          <div>
          ...
          <div>
            ...
            <img src="/public/images/line.jpg" className="relative  top-0 h-1 w-1000  z-3 " />
            <img src="/public/images/line.jpg" className="relative  left-250 -top-100 h-1 w-100  z-3 rotate-90 " />
        {/* Image */}
